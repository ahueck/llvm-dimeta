...
struct MemOps {
 ...
 private:
  const llvm::StringMap<MemOpKind> alloc_map_{
      ...
      {"hipMalloc", MemOpKind::kCudaMallocLike},
      {"hipHostMalloc", MemOpKind::kCudaMallocLike},
      {"hipMallocHost", MemOpKind::kCudaMallocLike},
      {"hipMallocPitch", MemOpKind::kCudaMallocLike},
      {"hipMallocArray", MemOpKind::kCudaMallocLike},
      {"hipMalloc3D", MemOpKind::kCudaMallocLike},
      {"hipMalloc3DArray", MemOpKind::kCudaMallocLike},
      {"hipMallocManaged", MemOpKind::kCudaMallocLike},
      {"hipMallocFromPoolAsync", MemOpKind::kCudaMallocLike},
      {"hipMallocAsync", MemOpKind::kCudaMallocLike},

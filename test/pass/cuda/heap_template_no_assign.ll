...
define internal noundef i32 @_ZL10cudaMallocIfE9cudaErrorPPT_m(ptr noundef %0, i64 noundef %1) !dbg !12 {
  %3 = alloca ptr, align 8, !DIAssignID !15
  call void @llvm.dbg.assign(metadata i1 undef, metadata !16, metadata !DIExpression(), metadata !15, metadata ptr %3, metadata !DIExpression()), !dbg !20
...
declare !dbg !38 i32 @cudaMalloc(ptr noundef, i64 noundef) 
...
!14 = distinct !DISubroutineType(types: !41)
